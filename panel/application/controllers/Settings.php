...
class Settings extends MY_Controller
{
    ...
    public function save()
    {
        ...
        if (checkEmpty($data)["error"] && (checkEmpty($data)["key"] === "company_name" || checkEmpty($data)["key"] === "email")) :
            ...
            $contact_logo = upload_picture("contact_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
            $blog_logo = upload_picture("blog_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
            ...
            $catalog = upload_picture("catalog", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
        ...
        if (!empty($settings)) :
            ...
            if (checkEmpty($data)["error"] && (checkEmpty($data)["key"] === "company_name" || checkEmpty($data)["key"] === "email")) :
                ...
                if (!empty($_FILES["contact_logo"]["name"])) :
                    $image = upload_picture("contact_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["blog_logo"]["name"])) :
                    $image = upload_picture("blog_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["service_logo"]["name"])) :
                    ...
                    if ($image["success"]) :
                        ...
                        echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Ayar Güncelleştirilirken Hata Oluştu. Faaliyet Logosusunu Seçtiğinizden Emin Olup, Lütfen Tekrar Deneyin."]);
                        die();
                    endif;
                endif;
                if (!empty($_FILES["sector_logo"]["name"])) :
                    $image = upload_picture("sector_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["about_logo"]["name"])) :
                    $image = upload_picture("about_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["gallery_logo"]["name"])) :
                    $image = upload_picture("gallery_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["service_logo"]["name"])) :
                    ...
                    if ($image["success"]) :
                        ...
                        echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Ayar Güncelleştirilirken Hata Oluştu. Faaliyet Logosu Seçtiğinizden Emin Olup, Lütfen Tekrar Deneyin."]);
                        die();
                    endif;
                endif;
                if (!empty($_FILES["service_detail_logo"]["name"])) :
                    $image = upload_picture("service_detail_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                        $data["service_detail_logo"] = $image["file_name"];
                    else :
                        echo json_encode(["success" => false, "title" => "Başarısız!", "message" => "Ayar Güncelleştirilirken Hata Oluştu. Faaliyet Detay Logosu Seçtiğinizden Emin Olup, Lütfen Tekrar Deneyin."]);
                        die();
                    endif;
                endif;
                if (!empty($_FILES["category_logo"]["name"])) :
                    $image = upload_picture("category_logo", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
                ...
                if (!empty($_FILES["catalog"]["name"])) :
                    $image = upload_picture("catalog", "uploads/$this->viewFolder",["width" => 1920, "height" => 200],"*");
                    if ($image["success"]) :
