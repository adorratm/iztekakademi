    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <h4 class="mb-3">
                ...
                <a href="javascript:void(0)" data-url="<?= base_url("service_categories/getCategories"); ?>" class="btn btn-sm btn-outline-primary rounded-0 btn-sm float-right syncServiceCategoryBtn"> <i class="fa fa-plus"></i> Faaliyet Kategorisi Ekle</a>
            </h4>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <form id="filter_form" onsubmit="return false">
                <div class="d-flex flex-wrap">
                    ...
                    <label for="search_button" class="mx-1">
                        <button class="btn btn-sm btn-outline-success rounded-0 " onclick="reloadTable('serviceCategoryTable')" id="search_button" data-toggle="tooltip" data-placement="top" data-title="Faaliyet Kategorisi Ara"><i class="fa fa-search"></i></button>
                </div>
            </form>
...
<script>
    $(document).ready(function() {
        $(document).on("click", ".updateServiceCategoryBtn", function(e) {
            ...
            createModal("#serviceCategoryModal", "Faaliyet Kategorisi Düzenle", "Faaliyet Kategorisi Düzenle", 600, true, "20px", 0, "#e20e17", "#fff", 1040, function() {
