...
class Blog extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $config["cur_tag_open"] = "<li class='current'><a class='current' title='" . $this->viewData->settings->company_name . "' rel='dofollow' href='" . str_replace("tr/index.php/", "", current_url()) . "'>";
        ...
        $this->viewData->page_title = clean(strto("lower|ucwords", (!empty($category) ? $category->title : lang("blog"))));
        $this->viewData->meta_title = clean(strto("lower|ucwords", (!empty($category) ? $category->title : lang("blog")))) . " - " . $this->viewData->settings->company_name;
        $this->viewData->meta_desc  = str_replace("”", "\"", @stripslashes($this->viewData->settings->meta_description));

        $this->viewData->og_url                 = clean(base_url(lang("routes_blog") . !empty($category) ? "/" . $category->seo_url : ""));
        $this->viewData->og_image           = clean(get_picture("settings_v", $this->viewData->settings->logo));
        $this->viewData->og_type          = "article";
        $this->viewData->og_title           = clean(strto("lower|ucwords", (!empty($category) ? $category->title : lang("blog")))) . " - " . $this->viewData->settings->company_name;
